...
ชุดข้อมูลรหัส **Avatar ID** ของตัวละครในเกม Zenless Zone Zero (ZZZ) ที่รวบรวมและจัดทำขึ้นด้วยมือ (Manual Mapping) เพื่อใช้เป็นฐานข้อมูลอ้างอิงในการปรับแต่งค่าต่าง ๆ ของตัวละคร

---

## 📝 รายละเอียดโปรเจกต์ (Project Details)

ข้อมูลทั้งหมดในไฟล์นี้เกิดจากการสำรวจและคัดกรองข้อมูลด้วยตัวเอง โดยการจับคู่ระหว่าง **ชื่อตัวละคร** และ **รหัส ID** เพื่อความสะดวกในการจัดการข้อมูลตัวละคร ไม่ว่าจะเป็นการแก้ไขเลเวล, สกิล หรืออุปกรณ์สวมใส่
...
2. **เครื่องมือแก้ไขออนไลน์:** สามารถใช้คู่กับ [PSConfig Editor](https://psconfig.zenlessfun.com/)
