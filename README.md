...
2. **เครื่องมือแก้ไขออนไลน์:** สามารถใช้คู่กับ [PSConfig Editor](https://psconfig.zenlessfun.com/) แล้วแก้ไข/เพิ่ม เสร็จแล้วนำไปใส่ใน \state\player\{ID_Account}\equip\
